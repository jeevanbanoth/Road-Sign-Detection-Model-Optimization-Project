...
train_ds = RoadDataset(df_train['new_path'], df_train['new_bb'], df_train['class'], transforms=True)
valid_ds = RoadDataset(df_train['new_path'], df_train['new_bb'], df_train['class'])
...
print(f"Training time for serial code is: {elapsed_time} seconds")
